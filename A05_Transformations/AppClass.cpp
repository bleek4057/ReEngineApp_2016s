...
#pragma region YOUR CODE GOES HERE
	...
	m_sunOrien = vector3(0.0f, m_fEarthTimer, 0.0f);
	m_earthOrien = vector3(0.0f, m_fEarthTimer, 0.0f);
	m_moonOrien = vector3(0.0f, 0.0f, m_fMoonTimer);


	//Calculate the position of the Sun
	m_m4Sun = glm::translate(IDENTITY_M4, m_sunTranslation);//m_sunTranslation is getting set in the camera input controls
	m_m4Sun = glm::rotate(IDENTITY_M4, m_sunOrien.x, vector3(1.0f, 0.0f, 0.0f));
	m_m4Sun = glm::rotate(m_m4Sun, m_sunOrien.y, vector3(0.0f, 1.0f, 0.0f));
	m_m4Sun = glm::rotate(m_m4Sun, m_sunOrien.z, vector3(0.0f, 0.0f, 1.0f));
	m_m4Sun = glm::scale(m_m4Sun, m_sunScale);

	//Calculate the position of the Earth
	m_m4Earth = glm::translate(m_m4Sun, vector3(20.0f, 0.0f, 0.0f));
	m_m4Earth = glm::rotate(m_m4Earth, m_earthOrien.x, vector3(1.0f, 0.0f, 0.0f));
	m_m4Earth = glm::rotate(m_m4Earth, m_earthOrien.y, vector3(0.0f, 1.0f, 0.0f));
	m_m4Earth = glm::rotate(m_m4Earth, m_earthOrien.z, vector3(0.0f, 0.0f, 1.0f));
	m_m4Earth = glm::scale(m_m4Earth, m_earthScale);

	//Calculate the position of the Moon
	m_m4Moon = glm::translate(m_m4Earth,vector3(1.0f, 0.0f, 0.0f));
	m_m4Moon = glm::rotate(m_m4Moon, m_moonOrien.x, vector3(1.0f, 0.0f, 0.0f));
	m_m4Moon = glm::rotate(m_m4Moon, m_moonOrien.y, vector3(0.0f, 1.0f, 0.0f));
	m_m4Moon = glm::rotate(m_m4Moon, m_moonOrien.z, vector3(0.0f, 0.0f, 1.0f));
	m_m4Moon = glm::scale(m_m4Moon, m_moonScale);
...
#pragma endregion
	...
	m_fEarthTimer = m_fMoonTimer / 28.0f; //divide by the moon's da
