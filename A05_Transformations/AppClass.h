...
class AppClass : public ReEngAppClass
{
	...
	vector3 m_sunTranslation = vector3(0.0f, 0.0f, 0.0f);//Moving the system around

	vector3 m_earthOrien = vector3(0.0f, 0.0f, 0.0f);//Earth orientation
	vector3 m_moonOrien = vector3(0.0f, 0.0f, 0.0f);//Moon orientation
	vector3 m_sunOrien = vector3(0.0f, 0.0f, 0.0f);//Sun orientations

	vector3 m_sunScale = vector3(0.4f, 0.4f, 0.4f);
	vector3 m_earthScale = vector3(3.0f, 3.0f, 3.0f);
	vector3 m_moonScale = vector3(2.0f, 2.0f, 2.0f);
